...
void GamePad::Update()
{
	...
	// キーボードでエミュレーション
	{
		...
		//if (GetAsyncKeyState('W') & 0x8000)newButtonState |= BTN_1;
		//if (GetAsyncKeyState('A') & 0x8000)newButtonState |= BTN_2;
		//if (GetAsyncKeyState('S') & 0x8000)newButtonState |= BTN_3;
		//if (GetAsyncKeyState('D') & 0x8000)newButtonState |= BTN_4;
